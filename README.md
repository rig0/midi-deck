...
[![Latest Tag](https://img.shields.io/github/v/tag/rig0/midi-deck?labelColor=222&color=80ff63&label=latest)](https://github.com/rig0/midi-deck/tags)
...
**Software for Midi Deck to interface with linux desktop audio (pipewire/pulsewire).**

</div>

> [!NOTE]
> Currently in early development.
> This software is intended to be used with proprietary hardware.
